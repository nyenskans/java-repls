...
public class Repl031 {
	...
	public static void main(String[] args) {
		 ...
		 * int temperature and ask user "What is the temperature outside?"
		 * 
		 ...
		 * "What is the temperature outside?" * If the temperature is higher than 85
		 * then "I am going to the beach * otherwise, "I am going to the park"* Example
		 * Output:
		 * 
		 * Is it sunny outside? It is a sunny day, I should go somewhere! What is the
		 * temperature outside? I am going to the beach! Example Output: Is it sunny
		 * outside? I stay home and practice Java! Example Output: Is it sunny outside?
		 * It is a sunny day, I should go somewhere! What is the temperature outside? I
