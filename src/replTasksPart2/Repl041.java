...
public class Repl041 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * First Output: "Enter the age of the Child" case 1: if age is 1 print as
		 * "You can Crawl" case 2 : if age is 2 print as "You can Talk" case 3: If age
		 * is 3 print as "You can Dance" case 4: if age is 4 print as
